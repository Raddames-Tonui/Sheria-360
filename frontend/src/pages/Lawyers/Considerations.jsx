      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="flex space-x-4">
            ...
            <img
              src="/svgs/info-1.svg"
              alt="Response and Communication"
              className="w-16 h-16"
            />
            <div>
              ...
              <ul className="list-disc list-inside space-y-1">
                ...
                <li>
                  Did you get to speak to an attorney directly or with a
                  receptionist?
                </li>
              </ul>
            </div>
          ...
          <div className="flex space-x-4">
            <img
              src="/svgs/info-2.svg"
              alt="Trustworthiness and Compatibility"
              className="w-16 h-16"
            />
            <div>
              <h3 className="text-xl font-semibold mb-1">
              ...
              <ul className="list-disc list-inside space-y-1">
                <li>
                  Is the lawyer telling you what you want to hear or being
          ...
          <div className="flex space-x-4">
            <img
              src="/svgs/info-3.svg"
              alt="Professional Experience, Academics, and Community Service"
              className="w-16 h-16"
            />
            <div>
              <h3 className="text-xl font-semibold mb-1">
              ...
              <ul className="list-disc list-inside space-y-1">
                <li>
                  Has the lawyer handled your specific issue before? If so, what
                  were the results?
                </li>
                <li>
                  What associations and affiliations does the attorney have?
                </li>
