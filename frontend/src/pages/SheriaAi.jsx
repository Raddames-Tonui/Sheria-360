...
const SheriaAi = () => {
  ...
  return (
    <div className="p-2 h-[90vh] bg-gray-100 flex justify-center">
      <div className=' bg-white border rounded-lg w-[60vw] h-[86vh] flex flex-col'>
      ...
      <hr className='bg-lime-700 '/>
        ...
        <div className="p-4 mx-10  bg-gray-50 border-x-1 shadow-md flex-1 h-[50vh] overflow-y-auto flex flex-col">
